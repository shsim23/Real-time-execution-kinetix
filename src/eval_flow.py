...
def eval(
    ...
    def execute_chunk(carry, _):
        ...
        return (rng, next_obs, next_env_state, next_action_chunk, next_n), (dones, env_states, infos, action_chunk_to_execute.transpose(1, 0, 2))
    ...
    dones, env_states, infos, actions = jax.tree.map(lambda x: x.reshape(-1, *x.shape[2:]), (dones, env_states, infos, actions))
    ...
    if return_all_states:
        return return_info, env_states, actions, dones
