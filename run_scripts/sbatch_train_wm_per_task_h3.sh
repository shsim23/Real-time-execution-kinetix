#!/bin/bash
#SBATCH --job-name=wm-pt-h3
#SBATCH --output=/home/prehj/slurm-logs/wm-pt-h3-%j.out
#SBATCH --error=/home/prehj/slurm-logs/wm-pt-h3-%j.err
#SBATCH --nodes=1
...
for TASK in "${TASKS[@]}"; do
  ...
  echo "========================================"
  echo "Training: $TASK_NAME (history_size=3)"
  echo "========================================"
